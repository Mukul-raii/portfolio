    ...
    <div className="flex flex-col justify-center items-center m-10 ">
      ...
      <div className="grid grid-cols-2 gap-8 relative">
        {contactData.map(({ label, icon: Icon, css, contact, display }) => (
          <div
            key={label}
            className="flex flex-row gap-5 p-6 rounded-3xl shadow-md border-2 border-neutral-100 relative transition-all duration-300 hover:-translate-y-1 ease-in-out  hover:bg-gradient-to-br from-blue-50 to-white"
          >
