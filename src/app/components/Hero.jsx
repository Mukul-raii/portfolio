...
const Hero = () => {
  return (
    <div className=" mt-52  mb-40 mx-10 flex flex-col sm:flex-row sm:gap-20">
      <div className="  flex flex-col  ">
        <div className="w-max py-1  px-3 rounded-3xl bg-gradient-to-r from-blue-300 to-purple-200 ">
          <p className=" text-md font-extrabold bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent ">
            Developer
          </p>
        </div>
        <article className="max-w-full pb-8 pt-6 sm:max-w-md text-wrap ">
          <h1 className="  text-4xl  md:text-5xl lg:text-6xl  font-bold tracking-tight mb-6  ">
            <span className="inline-block mr-4">Hey, I'm</span>
            <span className="relative inline-flex">Mukul Rai✨</span>
          </h1>
          <p className="sm:text-left mx-auto sm:mx-0 my-10 text-base sm:text-lg text-neutral-800 whitespace-normal break-words">
            <span>
        ...
        <div className="flex flex-row  gap-10 sm:my-10">
          <a
      ...
      <div className="group relative w-80 h-96 p-0 bg-gray-100 border-gray-200 rounded-2xl border-4 overflow-hidden hover:shadow-2xl transition-all duration-300 hover:bg-neutral-100  hover:p-5  hover:scale-105 flex items-center justify-center">
        <Image
